...
<body id="expimp-bg">
    ...
    <section id="view-details">
        <h4>Exporter Information</h4>

        <div class="row">
            <div class="column">
                <h6><strong>Expoter Code: </strong><span><?php echo $epp['exporter_code']; ?></span></h6>
                <h6><strong>Name: </strong><span><?php echo $epp['exporter_name']; ?></span></h6>
        ...
        <div class="table-responsive">
            ...
            <table id="exporter" class="display wrap" >
                ...
                <?php
                        $p = mysqli_query($db, "select * from link_exp_to_imp where exp_code='$code'");
                ...
                <tbody>
                    <tr>
                    <?php
                        $impp = mysqli_query($db, "select * from importer where importer_code='$imp'");
                        while($imp_d = mysqli_fetch_assoc($impp)){
                    ?>
                            <td><?php echo $imp_d['importer_code']; ?></td>
                            <td><?php echo $imp_d['importer_name']; ?></td>
                            <td><?php echo $imp_d['importer_code']; ?></td>
